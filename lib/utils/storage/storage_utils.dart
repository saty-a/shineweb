...
import '../../app/data/models/dto/user.dart';
import '../../app/data/models/response/app_config_response.dart';
...
class Storage {
  ...
  static User getUser() => User.fromJson(
      _box.read(StorageKeys.USER));
